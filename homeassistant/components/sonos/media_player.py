...
class SonosMediaPlayerEntity(SonosEntity, MediaPlayerEntity):
    ...
    def _play_media_share_link(
        self,
        soco: SoCo,
        share_link: ShareLinkPlugin,
        media_id: str,
        enqueue: MediaPlayerEnqueue,
    ) -> None:
        if enqueue == MediaPlayerEnqueue.ADD:
    ...
    def _play_media_track(
        self, soco: SoCo, media_id: str, enqueue: MediaPlayerEnqueue, is_radio: bool
    ) -> None:
    ...
    def _play_media_playlist(
        self, soco: SoCo, media_type: MediaType | str, media_id: str
    ) -> None:
    ...
    def _play_media_playable_types(
        self,
        soco: SoCo,
        media_type: MediaType | str,
        media_id: str,
